...
class CaptureDeployExecutionTests(unittest.TestCase):
    ...
    def test_execute_multi_region_all_succeed_records_aggregate_manifest(self) -> None:
        ...
        self.assertEqual(manifest["tags"], manifest["lifecycle_tags"])
        self.assertIn("component=capture", manifest["component_tags"]["capture"])
        self.assertIn("component=deploy", manifest["component_tags"]["deploy"])
